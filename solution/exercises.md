...
> Thí nghiệm thật ngày 11/09/2026 dùng `nex-agi/nex-n2.5-pro:free`, reasoning tắt, `top_p=0.9`, `max_tokens=256`: temperature 0.0 và 1.5 trả lời về cà phê, còn 0.5 và 1.0 trả lời về hang Sơn Đoòng; bản 1.5 diễn giải dài hơn bản 0.0. Temperature cao làm phân phối lấy mẫu bớt tập trung, nhưng bốn kết quả này không cho thấy độ đa dạng tăng đều theo temperature và không chứng minh tính đúng sai của thông tin. Mỗi mức mới chạy một lần nên cần lặp lại nhiều lần với cùng điều kiện để kết luận chắc hơn; phản hồi gốc và latency được lưu trong `experiment_results.json`.

### Câu 1.2 — Chọn temperature cho sản phẩm
**Bạn sẽ đặt temperature bao nhiêu cho chatbot hỗ trợ khách hàng, và tại sao?**
> Tôi chọn khoảng 0.2 để câu trả lời về chính sách, đơn hàng và quy trình ít biến động giữa các lượt, đồng thời vẫn tự nhiên. Khi thử temperature, tôi giữ top_p cố định để dễ xác định nguyên nhân thay đổi. Temperature thấp không bảo đảm câu trả lời đúng: chatbot vẫn cần dữ liệu chính sách được kiểm chứng, chỉ dẫn không tự bịa và chuyển cho nhân viên khi thiếu thông tin.
